...
define([
     ...
     * @param {Integer} options.days Number of days to be added
     * @return {Date}
     */
     ...
     * @param {Object} options
     * @param {Date} options.iDate Base Date
     * @param {Integer} options.days Number of days to be subtracted
     * @return {Date}
     */
    function subtractDays(options){
        ...
        var returnDate = new Date(earlier);
        return returnDate
    }
    /**
     ...
     * @param {Object} options
     * @param {Integer} options.minutes Number of minutes to be converted
     * @return {number}
     */
     ...
     * @param {Object} options
     * @param {Integer} options.minutes Number of minutes to convert
     * @return {Array}
     */
     ...
     * @param {Object} options
     * @param {Date} options.dateZero Base date to compare with
     * @param {Date} options.dateOne  Base date to compare with
     * @return {number}
     */
     ...
     * @param {Object} options
     * @param {Date} options.iDate Base Date
     * @param {Integer} options.endHour Hour you wish the return date to be set to NB 24 hour clock
     * @param {Integer} options.endMins Minutes you wish the return date to be set to
     * @return {Date}
     */
     ...
     * @param {Integer} options.startHour Hour to set the date to i.e 17 for 5pm
     * @param {Integer} options.startMins Minutes to set the date to i.e. 30 for half past
     * @return {Date}
     */
